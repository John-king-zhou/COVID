...
Para1=np.loadtxt('./Test_Criteria/Spl_Para%i_1.txt' % ii)
Para2=np.loadtxt('./Test_Criteria/Spl_Para%i_2.txt' % ii)
Para3=np.loadtxt('./Test_Criteria/Spl_Para%i_3.txt' % ii)
Para4=np.loadtxt('./Test_Criteria/Spl_Para%i_4.txt' % ii)
...
fig.subplots_adjust(bottom=0.1,top=0.9,left=0.07,right=0.97,wspace=0.3)
fig.text(0.5,0.02,s='time (weeks)',fontsize=16,horizontalalignment='center')
fig.savefig('./Test_Criteria/Illustration_Test_Criteria_%i.png'%ii,dpi=300)
plt.show()