...
def S_CD8(results,Para):
    load(results,Para)
    S_cd8 = k_CD8_naive*CD8Tn*(2**g3)/(t_CD8*g3)+k_CD8_mem*CD8Tm*(2**g4)/(t_CD8*g4)
    return S_cd8

def S_CD4(results,Para):
    load(results,Para)
    S_cd4 = k_CD4_naive*CD4Tn*2**g1/(t_CD4*g1)+k_CD4_mem*CD4Tm*2**g2/(t_CD4*g2)
    return S_cd4