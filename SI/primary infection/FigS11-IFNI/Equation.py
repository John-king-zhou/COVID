...
def func_med(x0,time,Para):
    ...
    f_APC_inf=1+h_APC_TNF*Hill(TNF,K_TNF_1,1)+h_APC_D*Hill(D,K_D_1,1)+h_APC_IFNg*Hill(IFN_g,K_IFNg_1,1)+h_APC_IFNI
    f_APC_anv=1+h_APC_IFNg*Hill(IFN_g,K_IFNg_1,1)+h_APC_IFNI
    f_NK_eff=1+h_NK_IL2*Hill(IL2,K_IL2_1,1)+h_NK_IFNI
    ...
    dnCoVdt=alpha*N1*d_If*If-(f_APC_anv*k_c_1*APC_l+f_APC_anv*k_c_2*APC_u+k_c_3*Neut+k_c_4*A*Ig+k_c_5*Ig_ex)*nCoV-d_v*Hill(nCoV,K_m,1)

    dIfdt=epsilon_IFNI*k_infect*nCoV*H-(f_APC_anv*k_k_1*APC_l+f_APC_anv*k_k_2*APC_u+f_NK_eff*k_k_3*NK+k_k_4*CTL+k_k_5*CD8Tm)*If-d_If*If

    dHdt=epsilon_IFNI*r_H-k_infect*nCoV*H-d_H*H
    ...
    dCD4Tadt=A_CD4*(1+h_CD4_IL2*Hill(IL2,K_IL2_2,1))*(k_CD4_naive*CD4Tn*2**g1/(t_CD4*g1)+k_CD4_mem*CD4Tm*2**g2/(t_CD4*g2))\
             -(k_Th1+k_Th2+k_Th17+k_Tfh+k_iTreg)*CD4Ta-k_mem_CD4*Hill(K_mem,APC_l,2)*CD4Ta-d_CD4_Treg*Treg_a*CD4Ta-d_lymph_GC*CD4Ta

    dTh1dt=k_Th1*CD4Ta-d_CD4_Treg*Treg_a*Th1-d_Th*Th1-d_lymph_GC*Th1

    dTh2dt=k_Th2*CD4Ta-d_CD4_Treg*Treg_a*Th2-d_Th*Th2-d_lymph_GC*Th2

    dTh17dt=k_Th17*CD4Ta-d_CD4_Treg*Treg_a*Th17-d_Th*Th17-d_lymph_GC*Th17

    dTfhdt=k_Tfh*CD4Ta-d_CD4_Treg*Treg_a*Tfh-d_Th*Tfh-d_lymph_GC*Tfh
    ...
    dCD8Tadt=A_CD8*(k_CD8_naive*CD8Tn*(2**g3)/(t_CD8*g3)+k_CD8_mem*CD8Tm*(2**g4)/(t_CD8*g4))*(1+h_CD8_IL2*Hill(IL2,K_IL2_5,1))\
             -k_CTL*CD8Ta-d_CD8_Treg*Treg_a*CD8Ta-k_mem_CD8*Hill(K_mem,APC_l,2)*CD8Ta-d_lymph_GC*CD8Ta

    dCTLdt=k_CTL*CD8Ta-k_k_4*CTL*If/N_ex-d_CD8_Treg*Treg_a*CTL-d_CTL*CTL-d_lymph_GC*CTL

    dCD8Tmdt=k_mem_CD8*Hill(K_mem,APC_l,2)*CD8Ta-k_CD8_mem*A_CD8*CD8Tm-d_CD8Tm*CD8Tm

    dBgcdt=A_B*(k_GC_naive*B0+k_GC_mem*Bm+r_gc*Hill(Tfh,K_Tfh_1,1)*Bgc)*(1-Bgc/K_GC)\
           -k_PB*A_B*Bgc-k_Bm*Bgc-d_GC*Bgc-d_lymph_GC*Bgc

    dPBdt=k_PB*A_B*Bgc-d_PB*PB-d_lymph_GC*PB
    ...
    dIL6dt=p_IL6_0+p_IL6_1*If+beta_GC*p_IL6_2*f_APC_inf*APC_l+beta_GC*p_IL6_3*Neut-c_IL6*IL6
...
def func_IFNI(x0,time,Para):
    ...
    f_APC_inf=1+h_APC_TNF*Hill(TNF,K_TNF_1,1)+h_APC_D*Hill(D,K_D_1,1)+h_APC_IFNg*Hill(IFN_g,K_IFNg_1,1)+h_APC_IFNI*Hill(IFNI,K_IFNI,1)
    f_APC_anv=1+h_APC_IFNg*Hill(IFN_g,K_IFNg_1,1)+h_APC_IFNI*Hill(IFNI,K_IFNI,1)
    f_NK_eff=1+h_NK_IL2*Hill(IL2,K_IL2_1,1)+h_NK_IFNI*Hill(IFNI,K_IFNI,1)
    epsilon_IFNI=1-alpha_IFNI*Hill(IFNI,K_IFNI,1)
